...
StatsLate <- Late %>%  
    group_by(Week) %>% 
    summarise(min = min(NumberofLateChildren),
              avg = mean(NumberofLateChildren),
              med = median(NumberofLateChildren),
              max = max(NumberofLateChildren),
              sd = sd(NumberofLateChildren), 
              var = var(NumberofLateChildren)) 
