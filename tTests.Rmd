...
**Examples**: [sleepOne](./Analyses/Examples/SleepOneSamplet.html)
...
**Examples**: [sleepPaired](./Analyses/Examples/SleepPairedt.html) [studentPaired](./Analyses/Examples/Student1Paired.html)
...
```{r, echo=FALSE}
sleep1 <- dplyr::filter(sleep, group==1)
sleep2 <- dplyr::filter(sleep, group==2)
```
...
**Examples**: [sleepInd](./Analyses/tExamples/SleepIndependentt.html) [student1](./Analyses/Examples/Student1Independent.html) [student2](./Analyses/Examples/Student2Independent.html)
